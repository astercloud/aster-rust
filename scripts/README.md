# Aster Benchmark Scripts

This directory contains scripts for running and analyzing Aster benchmarks.

## run-benchmarks.sh

This script runs Aster benchmarks across multiple provider:model pairs and analyzes the results.

### Prerequisites

- Aster CLI must be built or installed
...
3. For each provider:model pair:
   - Sets the `ASTER_PROVIDER` and `ASTER_MODEL` environment variables
