# 🍳 Contributing Recipes to aster Cookbook

Thank you for your interest in contributing to the aster Recipe Cookbook! This guide will walk you through the process of submitting your own recipe.
...
📚 **Need help with the format?** Check out the [Recipe Reference Guide](https://block.github.io/aster/docs/guides/recipes/recipe-reference) or [existing recipes](documentation/src/pages/recipes/data/recipes/) for examples.
...
- [ ] **Follow the format** - Refer to the [Recipe Reference Guide](https://block.github.io/aster/docs/guides/recipes/recipe-reference)
...
- 📚 **Check the docs** at [block.github.io/aster](https://block.github.io/aster/docs/guides/recipes/)
