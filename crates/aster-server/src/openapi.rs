use aster::agents::extension::Envs;
...
use aster::config::declarative_providers::{
...
#[openapi(
    paths(
        ...
        super::routes::agent::get_runtime_snapshot,
        ...
        super::routes::context::abstract_context,
        super::routes::context::overview_context,
        super::routes::context::read_context,
        super::routes::context::context_status,
        super::routes::memory::extract_memory,
        super::routes::memory::search_memory,
        super::routes::memory::memory_stats,
        super::routes::memory::memory_health,
    ...
    components(schemas(
        ...
        super::routes::context::ContextQuery,
        super::routes::context::ContextReadResponse,
        super::routes::context::ContextStatusResponse,
        super::routes::context::ContextNamespaceStatusResponse,
        super::routes::context::ContextTraceStepResponse,
        super::routes::memory::MemoryExtractRequest,
        super::routes::memory::MemorySearchRequest,
        super::routes::memory::MemorySearchResponse,
        super::routes::reply::ChatRequest,
        super::routes::reply::ContextTraceLevel,
        super::routes::reply::ContextTraceStepResponse,
        ...
        ActionRequired,
        ActionRequiredData,
        aster::conversation::message::ActionRequiredScope,
        ThinkingContent,
        ...
        SessionInsights,
        SessionType,
        aster::session::ItemRuntime,
        aster::session::ItemRuntimePayload,
        aster::session::ItemStatus,
        aster::session::SessionRuntimeSnapshot,
        aster::session::ThreadRuntime,
        aster::session::ThreadRuntimeSnapshot,
        aster::session::ThreadStatus,
        aster::session::TurnContextOverride,
        aster::session::TurnOutputSchemaRuntime,
        aster::session::TurnOutputSchemaSource,
        aster::session::TurnOutputSchemaStrategy,
        aster::session::TurnRuntime,
        aster::session::TurnStatus,
        aster::session::CommitReport,
        aster::session::MemoryCategory,
        aster::session::MemoryHealth,
        aster::session::MemoryRecord,
        aster::session::MemorySearchResult,
        aster::session::MemoryStats,
        Conversation,
        IconSchema,
        aster::session::extension_data::ExtensionData,
        ...
        aster::recipe::Recipe,
        aster::recipe::Author,
        aster::recipe::Settings,
        aster::recipe::RecipeParameter,
        aster::recipe::RecipeParameterInputType,
        aster::recipe::RecipeParameterRequirement,
        aster::recipe::Response,
        aster::recipe::SubRecipe,
        aster::agents::types::RetryConfig,
