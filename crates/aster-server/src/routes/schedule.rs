...
async fn create_schedule(
    ...
    scheduler
        ...
        .map_err(|e| {
            ...
            match e {
                aster::scheduler::SchedulerError::JobNotFound(_) => StatusCode::NOT_FOUND,
                aster::scheduler::SchedulerError::CronParseError(_) => StatusCode::BAD_REQUEST,
                aster::scheduler::SchedulerError::RecipeLoadError(_) => StatusCode::BAD_REQUEST,
                aster::scheduler::SchedulerError::JobIdExists(_) => StatusCode::CONFLICT,
    ...
    match scheduler.run_now(&id).await {
        ...
        Err(e) => {
            ...
            match e {
                ...
                aster::scheduler::SchedulerError::AnyhowError(ref err) => {
...
async fn pause_schedule(
    ...
    scheduler.pause_schedule(&id).await.map_err(|e| {
        ...
        match e {
            aster::scheduler::SchedulerError::JobNotFound(_) => StatusCode::NOT_FOUND,
            aster::scheduler::SchedulerError::AnyhowError(_) => StatusCode::BAD_REQUEST,
            _ => StatusCode::INTERNAL_SERVER_ERROR,
        }
    })?;
    Ok(StatusCode::NO_CONTENT)
