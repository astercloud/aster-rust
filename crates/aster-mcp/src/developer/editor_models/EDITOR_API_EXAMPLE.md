...
```bash
export ASTER_EDITOR_API_KEY="your-api-key-here"
export ASTER_EDITOR_HOST="https://api.openai.com/v1"
export ASTER_EDITOR_MODEL="gpt-4o"
```
...
**OpenAI:**
```bash
export ASTER_EDITOR_API_KEY="sk-..."
export ASTER_EDITOR_HOST="https://api.openai.com/v1"
export ASTER_EDITOR_MODEL="gpt-4o"
```
...
```bash
export ASTER_EDITOR_API_KEY="sk-ant-..."
export ASTER_EDITOR_HOST="https://api.anthropic.com/v1"
export ASTER_EDITOR_MODEL="claude-sonnet-4-20250514"
```

**Morph:**
```bash
export ASTER_EDITOR_API_KEY="sk-..."
export ASTER_EDITOR_HOST="https://api.morphllm.com/v1"
export ASTER_EDITOR_MODEL="morph-v3-large"
```

**Relace**
```bash
export ASTER_EDITOR_API_KEY="rlc-..."
export ASTER_EDITOR_HOST="https://instantapply.endpoint.relace.run/v1/apply"
export ASTER_EDITOR_MODEL="auto"
```

**Local/Custom endpoints:**
```bash
export ASTER_EDITOR_API_KEY="your-key"
export ASTER_EDITOR_HOST="http://localhost:8000/v1"
export ASTER_EDITOR_MODEL="your-model"
```
