...
impl TutorialServer {
    pub fn new() -> Self {
        ...
        let instructions = formatdoc! {r#"
            Because the tutorial extension is enabled, be aware that the user may be new to using aster
...
mod tests {
    ...
    async fn test_get_info() {
        ...
        assert_eq!(info.server_info.name, "aster-tutorial");
