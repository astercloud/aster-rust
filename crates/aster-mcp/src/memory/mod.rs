...
impl MemoryServer {
    pub fn new() -> Self {
        let instructions = formatdoc! {r#"
             ...
             3. Upon agreement:
                ...
                - Confirm the desired storage location:
                  - Local storage (.aster/memory) for project-specific details.
                  - Global storage (~/.config/aster/memory) for user-wide data.
        ...
        let global_memory_dir = choose_app_strategy(crate::APP_STRATEGY.clone())
            ...
            .unwrap_or_else(|_| PathBuf::from(".config/aster/memory"));
