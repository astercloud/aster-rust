...
use aster_bench::bench_config::BenchRunConfig;
use aster_bench::runners::bench_runner::BenchRunner;
use aster_bench::runners::eval_runner::EvalRunner;
use aster_bench::runners::metric_aggregator::MetricAggregator;
use aster_bench::runners::model_runner::ModelRunner;
use std::io::Read;
...
enum Command {
    ...
    #[command(
        ...
        long_about = "Runs a goose session tied to your terminal window.\n\
                      ...
                      Usage:\n  \
                        aster term run \"list files in this directory\"\n  \
                        @aster \"create a python script\"  # using alias\n  \
...
pub struct RecipeInfo {
    ...
    pub sub_recipes: Option<Vec<aster::recipe::SubRecipe>>,
    pub final_output_response: Option<aster::recipe::Response>,
    pub retry_config: Option<aster::agents::types::RetryConfig>,
}
    ...
    match (
        ...
        (_, _, Some(recipe_name)) => {
            ...
            let recipe_version = crate::recipes::search_recipe::load_recipe_file(recipe_name)
                .ok()
                .and_then(|rf| {
                    aster::recipe::template_recipe::parse_recipe_content(
                        &rf.content,
