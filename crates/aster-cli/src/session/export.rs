...
mod tests {
    use super::*;
    use aster::conversation::message::{Message, ToolRequest, ToolResponse};
...
if __name__ == "__main__":
    ...
    fn test_shell_tool_with_build_output() {
        ...
        let build_output = r#"   Compiling aster-cli v0.1.0 (/Users/user/aster)
...
10 |     let x = 5;
   ...
   = note: `#[warn(unused_variables)]` on by default
    ...
    Finished dev [unoptimized + debuginfo] target(s) in 2.45s"#;
        ...
        assert!(response_result.contains("Compiling aster-cli"));
