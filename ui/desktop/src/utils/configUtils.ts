export const configLabels: Record<string, string> = {
  // aster settings
  ASTER_PROVIDER: 'Provider',
  ASTER_MODEL: 'Model',
  ASTER_TEMPERATURE: 'Temperature',
  ASTER_MODE: 'Mode',
  ASTER_LEAD_PROVIDER: 'Lead Provider',
  ASTER_LEAD_MODEL: 'Lead Model',
  ASTER_PLANNER_PROVIDER: 'Planner Provider',
  ASTER_PLANNER_MODEL: 'Planner Model',
  ASTER_TOOLSHIM: 'Tool Shim',
  ASTER_TOOLSHIM_OLLAMA_MODEL: 'Tool Shim Ollama Model',
  ASTER_CLI_MIN_PRIORITY: 'CLI Min Priority',
  ASTER_ALLOWLIST: 'Allow List',
  ASTER_RECIPE_GITHUB_REPO: 'Recipe GitHub Repo',
