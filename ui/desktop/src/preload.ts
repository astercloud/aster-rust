...
type ElectronAPI = {
  ...
  getAsterdHostPort: () => Promise<string | null>;
...
const electronAPI: ElectronAPI = {
  ...
  getAsterdHostPort: () => ipcRenderer.invoke('get-asterd-host-port'),
  ...
  getVersion: (): string => {
    return config.ASTER_VERSION || ipcRenderer.sendSync('get-app-version') || '';
  },
  checkForUpdates: (): Promise<{ updateInfo: unknown; error: string | null }> => {
