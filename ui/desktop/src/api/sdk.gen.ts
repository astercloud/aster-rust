...
export const getRuntimeSnapshot = <ThrowOnError extends boolean = false>(options: Options<GetRuntimeSnapshotData, ThrowOnError>) => (options.client ?? client).get<GetRuntimeSnapshotResponses, GetRuntimeSnapshotErrors, ThrowOnError>({ url: '/agent/runtime/{session_id}', ...options });
...
export const abstractContext = <ThrowOnError extends boolean = false>(options: Options<AbstractContextData, ThrowOnError>) => (options.client ?? client).get<AbstractContextResponses, AbstractContextErrors, ThrowOnError>({ url: '/context/abstract', ...options });

export const overviewContext = <ThrowOnError extends boolean = false>(options: Options<OverviewContextData, ThrowOnError>) => (options.client ?? client).get<OverviewContextResponses, OverviewContextErrors, ThrowOnError>({ url: '/context/overview', ...options });

export const readContext = <ThrowOnError extends boolean = false>(options: Options<ReadContextData, ThrowOnError>) => (options.client ?? client).get<ReadContextResponses, ReadContextErrors, ThrowOnError>({ url: '/context/read', ...options });

export const contextStatus = <ThrowOnError extends boolean = false>(options?: Options<ContextStatusData, ThrowOnError>) => (options?.client ?? client).get<ContextStatusResponses, ContextStatusErrors, ThrowOnError>({ url: '/context/status', ...options });
...
export const extractMemory = <ThrowOnError extends boolean = false>(options: Options<ExtractMemoryData, ThrowOnError>) => (options.client ?? client).post<ExtractMemoryResponses, ExtractMemoryErrors, ThrowOnError>({
    url: '/memory/extract',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
export const memoryHealth = <ThrowOnError extends boolean = false>(options?: Options<MemoryHealthData, ThrowOnError>) => (options?.client ?? client).get<MemoryHealthResponses, MemoryHealthErrors, ThrowOnError>({ url: '/memory/health', ...options });

export const searchMemory = <ThrowOnError extends boolean = false>(options: Options<SearchMemoryData, ThrowOnError>) => (options.client ?? client).post<SearchMemoryResponses, SearchMemoryErrors, ThrowOnError>({
    url: '/memory/search',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
export const memoryStats = <ThrowOnError extends boolean = false>(options?: Options<MemoryStatsData, ThrowOnError>) => (options?.client ?? client).get<MemoryStatsResponses, MemoryStatsErrors, ThrowOnError>({ url: '/memory/stats', ...options });
