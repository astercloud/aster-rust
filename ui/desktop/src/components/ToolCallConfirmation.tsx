...
export default function ToolConfirmation({
  ...
  return isCancelledMessage ? (
    <div className="aster-message-content bg-background-muted rounded-2xl px-4 py-2 text-textStandard">
    ...
    <>
      ...
      {prompt && (
        <div className="aster-message-content bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-2xl px-4 py-2 mb-2 text-yellow-800 dark:text-gray-200">
          {prompt}
        </div>
      )}

      <div className="aster-message-content bg-background-muted rounded-2xl px-4 py-2 rounded-b-none text-textStandard">
        {prompt
          ? 'Do you allow this tool call?'
          : 'Aster would like to call the above tool. Allow?'}
      </div>
      {clicked ? (
        <div className="aster-message-tool bg-background-default border border-borderSubtle dark:border-gray-700 rounded-b-2xl px-4 pt-2 pb-2 flex items-center justify-between">
        ...
        <div className="aster-message-tool bg-background-default border border-borderSubtle dark:border-gray-700 rounded-b-2xl px-4 pt-2 pb-2 flex gap-2 items-center">
          <Button
