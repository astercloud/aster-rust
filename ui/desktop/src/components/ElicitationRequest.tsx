...
export default function ElicitationRequest({
  ...
  return (
    <div className="flex flex-col">
      <div className="aster-message-content bg-background-muted rounded-2xl rounded-b-none px-4 py-2 text-textStandard">
        {message || 'Aster needs some information from you.'}
      </div>
      <div className="aster-message-content bg-background-default border border-borderSubtle dark:border-gray-700 rounded-b-2xl px-4 py-3">
        <JsonSchemaForm
