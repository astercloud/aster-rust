...
export default function AsterMessage({
  sessionId,
  message,
  messages,
  ...
  return (
    <div className="aster-message flex w-[90%] justify-start min-w-0">
            ...
            <div className="relative flex flex-col w-full">
              <div className="flex flex-col gap-3">
                {toolRequests.map((toolRequest) => (
                  <div className="aster-message-tool" key={toolRequest.id}>
