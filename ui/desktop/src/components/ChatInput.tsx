...
export default function ChatInput({
  ...
  useEffect(() => {
    try {
      window.sessionStorage.setItem('aster-queue-paused', JSON.stringify(queuePausedRef.current));
    } catch (error) {
  ...
  useEffect(() => {
    try {
      window.sessionStorage.setItem('aster-queue-interruption', JSON.stringify(lastInterruption));
    } catch (error) {
