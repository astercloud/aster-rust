...
const IOS_APP_STORE_URL = 'https://apps.apple.com/us/app/aster-ai/id6752889295';
...
export default function TunnelSection() {
  ...
  const getQRCodeData = () => {
    ...
    return `asterchat://configure?data=${urlEncodedConfig}`;
  };
    ...
    <>
          ...
          <CardDescription className="flex flex-col gap-2">
            <div className="flex items-start gap-2 p-2 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded">
              ...
              <div className="text-xs text-blue-800 dark:text-blue-200">
                <strong>Preview feature:</strong> Enable remote access to aster from mobile devices
          ...
          {tunnelInfo.state === 'running' && (
            <div className="py-4 space-y-4">
              ...
              <div className="text-center text-sm text-text-muted">
                Scan this QR code with the aster mobile app. Do not share this code with anyone else
      ...
      <Dialog open={showAppStoreQRModal} onOpenChange={setShowAppStoreQRModal}>
        <DialogContent className="sm:max-w-[400px]">
          <DialogHeader>
            <DialogTitle>Download aster iOS App</DialogTitle>
          </DialogHeader>
          ...
          <div className="py-4 space-y-4">
            ...
            <div className="text-center text-sm text-text-muted">
              Scan this QR code with your iPhone camera to install the aster mobile app from the App
              Store
            </div>
