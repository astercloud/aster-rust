...
import ThemeSelector from '../../AsterSidebar/ThemeSelector';
...
export default function AppSettingsSection({ scrollToSection }: AppSettingsSectionProps) {
  ...
  // Check if ASTER_VERSION is set to determine if Updates section should be shown
  const shouldShowUpdates = !window.appConfig.get('ASTER_VERSION');
    ...
    <div className="space-y-4 pr-4 pb-8 mt-1">
      <Card className="rounded-lg">
        <CardHeader className="pb-0">
          ...
          <CardDescription>Configure how aster appears on your system</CardDescription>
        </CardHeader>
        <CardContent className="pt-4 space-y-4 px-4">
          ...
          {isMacOS && (
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-text-muted max-w-md mt-[2px]">Show aster in the dock</p>
              </div>
              <div className="flex items-center">
                <Switch
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-text-muted max-w-md mt-[2px]">
                Keep your computer awake while aster is running a task (screen can still lock)
              </p>
            </div>
            <div className="flex items-center">
              <Switch
      ...
      <Card className="rounded-lg">
        <CardHeader className="pb-0">
          ...
          <CardDescription>Customize the look and feel of aster</CardDescription>
        </CardHeader>
      ...
      <Card className="rounded-lg">
        <CardHeader className="pb-0">
          ...
          <CardDescription>
            Help us improve aster by reporting issues or requesting new features
          </CardDescription>
        </CardHeader>
        <CardContent className="pt-4 px-4">
          <div className="flex space-x-4">
            <Button
              onClick={() => {
                window.open(
                  'https://github.com/astercloud/aster-rust/issues/new?template=bug_report.md',
                  '_blank'
                );
              }}
              variant="secondary"
            ...
            <Button
              onClick={() => {
                window.open(
                  'https://github.com/astercloud/aster-rust/issues/new?template=feature_request.md',
                  '_blank'
                );
              }}
              variant="secondary"
      ...
      {/* Version Section - only show if ASTER_VERSION is set */}
      {!shouldShowUpdates && (
        <Card className="rounded-lg">
          <CardHeader className="pb-0">
          ...
          <CardContent className="pt-4 px-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-mono text-black dark:text-white">
                {String(window.appConfig.get('ASTER_VERSION') || 'Development')}
              </span>
            </div>
          </CardContent>
        </Card>
      ...
      {/* Update Section - only show if ASTER_VERSION is NOT set */}
        ...
        <div ref={updateSectionRef}>
          <Card className="rounded-lg">
            <CardHeader className="pb-0">
              ...
              <CardDescription>
                Check for and install updates to keep aster running at its best
              </CardDescription>
            </CardHeader>
            ...
            {isMacOS ? (
              <div className="space-y-4">
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  ...
                  <li>Find and select aster in the application list</li>
