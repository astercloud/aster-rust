...
describe('Extension Utils', () => {
  ...
  describe('extractExtensionName', () => {
    it('should extract extension name from link', () => {
      const link = 'aster://extension/add?name=Test%20Extension&cmd=python';
    ...
    it('should decode URL encoded names', () => {
      const link = 'aster://extension/add?name=My%20Special%20Extension%21';
