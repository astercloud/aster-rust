...
import { AsterhintsSection } from './AsterhintsSection';
    ...
    <div className="space-y-4 pr-4 pb-8 mt-1">
      <Card className="pb-2 rounded-lg">
        <CardHeader className="pb-0">
          ...
          <CardDescription>Configure how Aster interacts with tools and extensions</CardDescription>
        </CardHeader>
      ...
      <Card className="pb-2 rounded-lg">
        <CardHeader className="pb-0">
          ...
          <CardDescription>Choose how Aster should format and style its responses</CardDescription>
        </CardHeader>
        <CardContent className="px-2">
