...
export default function TelemetryOptOutModal(props: TelemetryOptOutModalProps) {
  ...
  useEffect(() => {
    ...
    const checkTelemetryChoice = async () => {
      try {
        const provider = await read('ASTER_PROVIDER', false);
    ...
    >
      <div className="px-2 py-3">
        <div className="flex justify-center mb-4">
          <Aster className="size-10 text-text-default" />
        </div>
        ...
        <p className="text-text-default text-sm mb-3">
          Would you like to help improve aster by sharing anonymous usage data? This helps us
          understand how aster is used and identify areas for improvement.
        </p>
        <div className="text-text-muted text-xs space-y-1">
          ...
          <ul className="list-disc list-inside space-y-0.5 ml-1">
            ...
            <li>aster version and install method</li>
